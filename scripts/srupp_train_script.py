...
from nlplay.models.pytorch.classifiers.sru.srupp_model import SRUppClassifier
...
model = SRUppClassifier(num_classes=ds.num_classes, vocabulary_size=ds.vocab_size,
                        embedding_size=embedding_size, hidden_size=hidden_size, proj_size=proj_size,
