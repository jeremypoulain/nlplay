"""
Title    : Quasi-hyperbolic momentum and Adam for deep learning - 2019
Authors  : Jerry Ma, Denis Yarats
Papers   : https://arxiv.org/pdf/1810.06801.pdf
Source   : https://github.com/facebookresearch/qhoptim
           https://github.com/facebookresearch/qhoptim/blob/master/qhoptim/pyt/qhadam.py
"""
import collections
import torch
...
class QHAdam(Optimizer):
    ...
    def from_nadam(cls, lr=1e-3, betas=(0.9, 0.999)):
        ...
        """
        return cls._params_to_dict(from_nadam(lr, betas[0], betas[1]))
