"""
Credits : https://github.com/davidtvs/pytorch-lr-finder
"""
...
class LRFinder(object):
    ...
    def plot(self, skip_start=10, skip_end=5, log_lr=True, show_lr=None, show: bool = False, folder_path:str = None):
        ...
        if folder_path is not None:
            path = os.path.join(folder_path, 'lr_finder.png')
